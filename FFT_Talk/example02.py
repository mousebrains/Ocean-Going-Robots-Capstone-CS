...
#
# Plot both the displacement and velocity
#
...
def initFunc() -> None:
    ...
    ax1.set_ylabel("Velocity", color=color1)
...
def animate(t:float, *args) -> None:
    ...
    line1.set_ydata(velocity(x, t, k, omega)) # Update the plot's data
...
line1, = ax1.plot(x, velocity(x, 0, k, omega), color=color1) # Initial line at t=0
